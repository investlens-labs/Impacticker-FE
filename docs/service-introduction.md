...
Impacticker는 관심 종목과 관련된 뉴스를 한곳에 모으고, 뉴스가 기업에 미칠 수 있는 영향을 빠르게 파악하도록 돕는 금융 정보 서비스입니다.
...
> Impacticker의 뉴스 분석은 투자 참고 정보이며 투자 조언이나 주가 예측이 아닙니다.
...
Impacticker는 다음 과정을 하나의 서비스 안에서 연결합니다.
...
|---:|---|
| 1점 | 영향이 거의 없음 |
| 2~4점 | 제한적이거나 중간 이하의 영향 가능성 |
| 5점 | 중간 수준 영향 |
| 6~9점 | 중간 이상에서 중대한 영향 가능성 |
| 10점 | 매우 크고 즉각적인 영향 가능성 |

점수는 호재·악재의 방향을 뜻하는 값이 아니라, 해당 뉴스가 기업에 미칠 수 있는 **영향의 중요도**를 나타냅니다. 종목 직접 뉴스뿐 아니라 기사에 근거가 있는 산업, 경쟁사, 공급망, 고객사, 규제, 금리와 환율의 간접 영향도 평가 범위에 포함됩니다.
...
- 종목, 시세, 뉴스 데이터는 Impacticker 백엔드만 호출합니다.
